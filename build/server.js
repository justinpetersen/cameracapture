...
var application = new CameraCaptureApplication( );
application.init( );

function CameraCaptureApplication( ) {
	...
	this.onServerHandler = function( directory, file, req, res ) {
		...
		console.log( 'CameraCapture.onServerHandler( )' );
	...
	this.routeFile = function( directory, file ) {
		...
		console.log( 'CameraCapture.routeFile( ' + directory + ', ' + file + ' )' );
